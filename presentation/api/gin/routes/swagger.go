    ...
    "schemas": {
      ...
      "DispenserDetail": {
        ...
        "properties": {
          ...
          "puerto": { "type": "string" },
          "bloqueo": { "type": "string" },
          "conexion": { "type": "integer" },
          "manguera": { "type": "integer" },
          "surtidor": { "type": "integer" },
          "lector_ip": { "type": "string" },
          "bodegas_id": { "type": "integer" },
          "familia_id": { "type": "integer" },
          "lector_rfid": { "type": "string" },
          "productos_id": { "type": "integer" },
          "lector_puerto": { "type": "integer" },
          "salto_lectura": { "type": "string" },
          "surtidores_id": { "type": "integer" },
          "estado_publico": { "type": "integer" },
          "familia_codigo": { "type": "string" },
          "motivo_bloqueo": { "type": "string" },
          "precio_familia": { "type": "number" },
          "acumulado_venta": { "type": "integer", "format": "int64" },
          "producto_precio": { "type": "number" },
          "ultima_conexion": { "type": "string" },
          "bytes_totalizador": { "type": "integer" },
          "familia_atributos": { "type": "object", "additionalProperties": true },
          "acumulado_cantidad": { "type": "integer", "format": "int64" },
          "acumulado_venta_surt": { "type": "integer", "format": "int64" },
          "producto_descripcion": { "type": "string" },
          "acumulado_cantidad_surt": { "type": "integer", "format": "int64" },
          "factor_predeterminacion_importe": { "type": "integer" }
        }
      },
      ...
      "ParametrosPOS": {
        ...
        "properties": {
          "POS_ID": { "type": "string" },
          "version_pos": { "type": "string" },
          "POS_PRINCIPAL": { "type": "string" },
          "OBLIGATORIO_FE": { "type": "string" },
          "MONTO_MINIMO_FE": { "type": "string" },
          "tipo_autorizacion": { "type": "string" },
          "solicitar_lecturas_tanques": { "type": "string" }
        }
      },
      "Equipment": {
        "type": "object",
        "properties": {
          ...
          "empresas_id": { "type": "integer" },
          "lector_port": { "type": "integer" },
          "update_date": { "type": "string" },
          "update_user": { "type": "integer" },
          "impresora_ip": { "type": "string" },
          "factor_precio": { "type": "integer" },
          "serial_equipo": { "type": "string" },
          "factor_importe": { "type": "integer" },
          "impresora_port": { "type": "integer" },
          "equipos_tipos_id": { "type": "integer" },
          "factor_inventario": { "type": "integer" },
          "almacenamientos_id": { "type": "integer" },
          "equipos_protocolos_id": { "type": "integer" }
        }
      },
      "Journal": {
        "type": "object",
        "properties": {
          ...
          "atributos": { "type": "object", "additionalProperties": true },
          "fecha_fin": { "type": "string" },
          "equipos_id": { "type": "integer" },
          "personas_id": { "type": "integer" },
          "fecha_inicio": { "type": "string" },
          "sincronizado": { "type": "integer" },
          "grupo_jornada": { "type": "integer", "format": "int64" },
          "surtidores_id": { "type": "integer" }
        }
      },
      "Company": {
        ...
        "properties": {
          ...
          "dominio_id": { "type": "integer" },
          "negocio_id": { "type": "integer" },
          "ciudades_id": { "type": "integer" },
          "create_date": { "type": "string" },
          "create_user": { "type": "integer" },
          "empresas_id": { "type": "integer" },
          "update_date": { "type": "string" },
          ...
          "contacto_correo": { "type": "string" },
          "contacto_nombre": { "type": "string" },
          "id_tipo_empresa": { "type": "integer" },
          "contacto_telefono": { "type": "string" },
          "empresas_tipos_id": { "type": "integer" },
          "cantidad_sucursales": { "type": "integer" },
          "ciudades_descripcion": { "type": "string" },
          "proveedor_tecnologico_id": { "type": "integer" }
        }
      },
      "Promoter": {
        "type": "object",
        "properties": {
          ...
          "update_user": { "type": "integer" },
          "sincronizado": { "type": "integer" },
          "sucursales_id": { "type": "integer" },
          "identificacion": { "type": "string" },
          "fecha_nacimiento": { "type": "string" },
          "tipos_identificacion_id": { "type": "integer" }
        }
      },
      "Dispenser": {
        "type": "object",
        "properties": {
          ...
          "token": { "type": "string" },
          "estado": { "type": "string" },
          "islas_id": { "type": "integer" },
          "surtidor": { "type": "integer" },
          "lector_ip": { "type": "string" },
          "tiene_echo": { "type": "string" },
          "controlador": { "type": "integer" },
          "create_date": { "type": "string" },
          "create_user": { "type": "integer" },
          "empresas_id": { "type": "integer" },
          "lector_port": { "type": "integer" },
          "update_date": { "type": "string" },
          "update_user": { "type": "integer" },
          "debug_estado": { "type": "string" },
          "debug_tramas": { "type": "string" },
          "impresora_ip": { "type": "string" },
          "factor_precio": { "type": "integer" },
          "impresora_port": { "type": "integer" },
          "bytes_totalizador": { "type": "integer" },
          "factor_inventario": { "type": "integer" },
          "surtidores_tipos_id": { "type": "integer" },
          "factor_importe_parcial": { "type": "integer" },
          "factor_volumen_parcial": { "type": "integer" },
          "surtidores_protocolos_id": { "type": "integer" },
          "factor_predeterminacion_volumen": { "type": "integer" }
        }
      },
      "PaymentMethod": {
        "type": "object",
        "properties": {
          ...
          "estado": { "type": "string" },
          "descripcion": { "type": "string" },
          "mp_atributos": { "type": "object", "additionalProperties": true },
          "integracion_id": { "type": "integer" },
          "id_sincronizado": { "type": "integer" },
          "codigo_adquiriente": { "type": "string" },
          "base64_seleleccionado": { "type": "string" },
          "id_medio_pago_recurso": { "type": "string" },
          "id_medio_pago_recurso_seleccionado": { "type": "string" }
        }
      },
      "InitialConfiguration": {
        "type": "object",
        "properties": {
          "equipo": { "$ref": "#/components/schemas/Equipment" },
          "jornada": { "$ref": "#/components/schemas/Journal" },
          "empresas": { "type": "array", "items": { "$ref": "#/components/schemas/Company" } },
          "promotor": { "$ref": "#/components/schemas/Promoter" },
          "parametros": { "$ref": "#/components/schemas/ParametrosPOS" },
          "surtidores": { "type": "array", "items": { "$ref": "#/components/schemas/Dispenser" } },
          "medios_pagos": { "type": "array", "items": { "$ref": "#/components/schemas/PaymentMethod" } },
          "turno_activo": { "type": "boolean" },
          "surtidores_detalles": { "type": "array", "items": { "$ref": "#/components/schemas/DispenserDetail" } }
        }
      },
